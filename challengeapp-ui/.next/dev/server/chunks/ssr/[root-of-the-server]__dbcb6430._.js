...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5015/api/v1")}/auth/login`, {
                email,
                password
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dbcb6430._.js.map