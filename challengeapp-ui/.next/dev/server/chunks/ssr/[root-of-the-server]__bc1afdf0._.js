...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5015/api/v1")}/auth/login`, {
                email,
                password
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bc1afdf0._.js.map