...
(()=>{
    const e = new Error("Cannot find module '../components/UploadModal'");
...
function DashboardPage() {
    ...
    const fetchDocuments = async ()=>{
        ...
        setLoading(true);
        try {
            const url = `${("TURBOPACK compile-time value", "http://localhost:5015/api/v1")}/documents`;
            ...
            const { items, totalPages: totalPages_0 } = response.data || {};
            setDocuments(Array.isArray(items) ? items : []);
            setTotalPages(totalPages_0 || 1);
            setError("");
        } catch (err) {
            console.error("❌ Failed to load documents:", err.response?.status, err.response?.data || err.message);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            showModal && token && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UploadModal, {
                token: token,
...
_s(DashboardPage, "+vGjjxGMoJ/RCvVsrNFP+SMA0bI=", false, function() {
    return [
